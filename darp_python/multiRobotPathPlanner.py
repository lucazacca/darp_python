...
class MultiRobotPathPlanner(DARP):
    def __init__(self, nx, ny, notEqualPortions, initial_positions, portions,
        ...
        if not self.DARP_success:
            ...
            # print(f'Trajectory for robot 1\n')
            # print(best_case_returnPaths[0])
            # print(f'Trajectory for robot 2\n')
            # print(best_case_returnPaths[1])
            # print(f'Trajectory for robot 3\n')
            # print(best_case_returnPaths[2])
